...
_SPARSEDOCUMENT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='primary_index', full_name='topicspace.corpus.nlp.SparseDocument.primary_index', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='secondary_index', full_name='topicspace.corpus.nlp.SparseDocument.secondary_index', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='token_index', full_name='topicspace.corpus.nlp.SparseDocument.token_index', index=2,
